...
public class PalmerPenguinsM3 {
   ...
   // constants to represents species and count
   ...
   public static void main(String[] args) {
      ...
      // output the species names with text
      ...
      System.out.printf("%s: %d (%.2f%%)\n", "Gentoo", 123, 35.96);
      System.out.printf("%s: %d (%.2f%%)\n", "Adelie", 151, 44.15);
      System.out.printf("Total number of penguins: " + totalPenguins + "\n");
      ...
      else if (NUM_GENTOO > NUM_CHINSTRAP && NUM_GENTOO >
      NUM_ADELIE) {
         System.out.println(SP_GENTOO + " penguins are the most populous.");
      }
      else if (NUM_ADELIE > NUM_CHINSTRAP && NUM_ADELIE >
      NUM_GENTOO) {
